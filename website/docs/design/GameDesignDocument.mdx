...
1. Prepare: Equip Gear, Equip Abilities, Form Party, Select Contract, Food, Potions, Rift modification
2. Rift: exploration, combat, loot, objective
3. Advance: Delooting, upgrading (gear,abilities,guilds)

```mermaid
flowchart LR
    A[Prepare] --> B[Rift] --> C[Advance]
    C --> A
```
